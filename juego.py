...
def play():
    ...
    while playing:
        ...
        print("What part should I use to attack? (Enter 'q' to quit)")
        part_to_use = input("Choose a part number: ")
        if part_to_use.lower() == "q":
            print("You chose to quit the game.")
            break
        part_to_use = int(part_to_use)

        enemy_robot.print_status()
        print("Which part of the enemy should we attack? (Enter 'q' to quit)")
        part_to_attack = input("Choose an enemy part to attack: ")
        if part_to_attack.lower() == "q":
            print("You chose to quit the game.")
            break
